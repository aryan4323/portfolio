    ...
    <div className={`min-h-screen font-sans transition-colors duration-500 ${themeClasses}`}>
      ...
      <div className="flex justify-end p-4">
        <button
          ...
          className="px-4 py-2 rounded-full bg-gradient-to-r from-purple-500 to-indigo-500 text-white font-semibold hover:scale-105 transition"
        >
      ...
      <header className="text-center py-12">
        <h1 className="text-5xl font-bold mb-2">Aryan Tyagi</h1>
        <p className="text-xl font-semibold text-gray-400">Front End Developer</p>
        <a
          href="/resume.pdf"
          download
          className="inline-block mt-4 px-6 py-2 bg-gradient-to-r from-blue-500 to-purple-500 text-white rounded-lg font-semibold hover:scale-105 transition"
        >
          Download Resume
        </a>
      </header>
